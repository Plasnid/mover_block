function Hero(moveSound, bonkSound, heroSpeed, heroIcon){
    //* reference for audio
...
//* random colours tool
Hero.prototype.randoCol = function(){
...
function GameBoard(playSpace, gameHero){
...
GameBoard.prototype.moveDir = function(motionDir){
...
//* keyboard commands
GameBoard.prototype.keyPressAction = function(e){
    console.log(this);
    switch(e.keyCode){
        case 38:
